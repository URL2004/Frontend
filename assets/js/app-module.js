...
window.loadNotices = async () =>{
 ...
 if (!CU) {
  const samples = [
   ['업데이트','휴머나이징 엔진 v2.5 업데이트 — 문단 구조 보존 강화','2026.07.22','1,246'],
   ['정책','AI 감지 크레딧 이용 방식 전환 안내 (100자당 1크레딧)','2026.07.20','3,512'],
   ['정책','환불 정책 개정 안내 — 7일 이내 사용량 비례 환불','2026.07.20','2,189'],
   ['업데이트','AI 감지 보고서 문단별 미리보기·전체보기 개선','2026.07.20','1,102'],
   ['업데이트','휴머나이징 결과 보관함·작업 복구 안정화','2026.07.16','1,876'],
   ['공지','서비스 리브랜딩 안내 — AI 휴머나이징으로 새단장','2026.07.10','1,023'],
   ['업데이트','자소서·지원서 장르 재구성 품질 개선','2026.07.08','1,532'],
   ['업데이트','긴 문서 처리 속도·안정성 개선','2026.07.05','987']
  ];
