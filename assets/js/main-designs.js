(function () {
  ...
  var TAB_IDS = ['main', 'pricing', 'community', 'guide', 'faq', 'qna', 'notice', 'mypage', 'admin', 'adminHumanizeLab', 'history', 'pro'];
  var MOVED_TABS = ['history', 'notice', 'community', 'guide', 'faq', 'qna', 'pricing', 'pro', 'mypage', 'admin', 'adminHumanizeLab'];
