...
4. 크레딧 소비 기준은 기능별로 다르며, AI 감지는 100자당 1크레딧, 기본 휴머나이징은 최소 10크레딧 및 100자당 2크레딧 기준으로 차감됩니다. 모든 문서에 의미 검증을 수행하는 고급 휴머나이징은 3,000자 이하 100크레딧을 기준으로 하며, 초과 길이는 5크레딧 단위 단계형 요금을 적용합니다. 근거 보강 추가금은 입력 길이에 따라 50~100크레딧입니다. 글 구조 개선을 선택하면 고급 기본요금의 30%를 정수 크레딧으로 올림하여 추가하며, 근거 보강 요금에는 중복 적용하지 않습니다. 구조 변경을 적용하지 않으면 구조 추가요금은 차감하지 않습니다. 실행 전에 실제 글자 수로 계산한 금액을 안내합니다. 기준 변경 시 사전 공지합니다.
