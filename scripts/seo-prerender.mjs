...
const ROUTES = [
  ...
  },
  {
    ...
    h1: '교수님 피하기 요금제',
    description:
      '교수님 피하기 크레딧 충전과 구독 플랜 안내. 탐지는 100자당 1크레딧, 휴머나이징은 최소 10크레딧부터 사용할 수 있으며 충전 크레딧은 소멸 기한 없이 사용할 수 있습니다.',
    breadcrumb: '요금제',
    faq: false
  },
  {
...
const FAQ_ITEMS = [
  ...
  ['크레딧은 어떻게 충전하나요?', '충전하기 메뉴에서 원하는 크레딧을 선택해 토스·카카오페이로 결제하면 즉시 충전됩니다. 탐지는 100자당 1크레딧, 휴머나이징은 최소 10크레딧 및 100자당 2크레딧 기준입니다.'],
