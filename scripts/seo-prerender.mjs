...
const ROUTES = [
  {
    ...
    url: '/',
    partial: 'main.html',
    title: '교수님 피하기 – AI 휴머나이저 · AI 감지 무료 확인',
    h1: '교수님 피하기 AI 휴머나이저',
    description:
      'AI로 작성한 글을 자연스럽고 사람답게 다듬는 AI 휴머나이저. AI 티 지수는 무료로 확인하고, 휴머나이징으로 문장을 사람답게 바꿔보세요.',
    breadcrumb: null,
    faq: false
  },
  {
  ...
  },
  {
    ...
    title: '무료 AI 감지기 – AI 티 지수 확인 · 문장 분석 | 교수님 피하기',
    h1: '무료 AI 감지기',
    description:
      '제출 전 글을 붙여넣고 AI 작성 흔적과 AI 티 나는 문장을 무료로 확인하세요. AI 감지 결과를 바탕으로 휴머나이징까지 이어갈 수 있습니다.',
...
const FAQ_ITEMS = [
  ...
  ['무료로 사용할 수 있나요?', 'AI 감지(AI 티 지수 확인)는 일일 한도 내에서 무료로 이용할 수 있어요. 문장을 사람답게 바꾸는 휴머나이징은 크레딧이 차감됩니다.'],
