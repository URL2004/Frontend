...
<p data-member-text="작업실에 글을 붙여넣으면 문단별 AI 문체 신호를 바로 확인할 수 있어요. 실패한 작업은 차감되지 않습니다.">${esc(article.ctaDesc || '가입하면 20크레딧으로 600자 글의 AI 감지와 기본 휴머나이징을 이어서 써볼 수 있어요. 실패한 작업은 차감되지 않습니다.')}</p>
<a href="${article.ctaHref || '/'}" data-member-label="${article.ctaHref ? esc(article.ctaLabel || '열어 보기') : '작업실 열기'}">${esc(article.ctaLabel || '무료 20크레딧으로 시작하기')}</a>
</div>
...
<a href="/" data-member-label="작업실 열기">무료 20크레딧으로 시작하기</a>
</div>
...
<p data-member-text="작업실에 글을 붙여넣으면 문단별 AI 문체 신호를 바로 확인할 수 있어요. 실패한 작업은 차감되지 않아요.">글을 붙여넣으면 문단별 AI 문체 신호를 바로 보여드립니다. 가입 시 20크레딧 제공, 실패한 작업은 차감되지 않아요.</p>
</div>
<a href="/" data-member-label="작업실 열기">무료 20크레딧으로 시작하기</a>
</div>
</article>`;
